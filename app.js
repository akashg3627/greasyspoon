...
app.use(expressCspHeader({
    directives: {
        'default-src': [SELF, '*.google.com', 'https://kit.fontawesome.com/', 'https://images.squarespace-cdn.com', 'https://fonts.gstatic.com/',
...
if (process.env.NODE_ENV === 'production') {
    // Set static folder
    app.use(express.static('gsadmin/build'));

    app.get('*', (req, res) => {
        res.sendFile(path.resolve(__dirname, 'gsadmin', 'build', 'index.html'));
    });
}
